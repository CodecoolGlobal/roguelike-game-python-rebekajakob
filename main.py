...
def main():
    ...
    while is_running:
        ...
        if button in direction_vectors:
            ...
            if engine.check_target_cell(current_room, player_coordinates, direction) == 1:
            ...
            elif engine.check_target_cell(current_room, player_coordinates, direction) == 2:
                current_room[player_coordinates[0]][player_coordinates[1]] = 0
            ...
            elif engine.check_target_cell(current_room, player_coordinates, direction) == 3:
                current_room[player_coordinates[0]][player_coordinates[1]] = 0
                current_room_index += 1    
                current_room = board[current_room_index]
